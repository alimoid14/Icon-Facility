...
function Team() {
  ...
  const members = [
    { img: Kishan, title: "Kishan", caption: "Executive Director", role: "executive-director" ,description:"With over eight years of expertise in facility management services, Kishan brings strong leadership and deep client insight. He is committed to delivering excellence while fostering long-term, trust-based relationships with clients." },
    { img: Abhishek, title: "Kishan", caption: "Abhishek Sharma", role: "executive-director", description:"An MBA in Marketing with five years of experience in facility management, he combines expertise with a client-focused approach, delivering services with passion, patience, and a positive attitude." },
    ...
    { img: Kishan, title: "Roberto Davis", caption: "Housekeeper", role: "housekeeping-boys" },
    ...
    <>
      ...
      <div className="members d-flex flex-wrap gap-5 align-items-center justify-content-center mb-5 p-5 bg-dark">
        {filteredMembers.map((m, idx) => (
          <MemberCard key={idx} imgsrc={m.img} title={m.title} caption={m.caption}  description={m.description}/>
        ))}
      </div>
    </>
  )
