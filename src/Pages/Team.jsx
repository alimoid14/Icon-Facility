...
function Team() {
  const pageTitle = "Our Team | ICON Facility";
  const pageDesc =
    "Meet the dedicated professionals behind ICON Facility — experts in industrial cleaning, facility management, and operational excellence.";
  const heroImg = Teampic;
  // const pageUrl = "https://yourdomain.com/team";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="ICON Facility team, cleaning experts, facility management professionals, industrial cleaning specialists, management staff"
        />
