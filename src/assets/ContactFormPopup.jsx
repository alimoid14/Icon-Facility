  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-xl shadow-xl p-6 md:p-12 w-96 md:w-2xl relative overflow-visible">
        <div className="absolute rounded-xl w-full h-full top-4 left-4 transform border-2 border-dashed border-orange-300 -z-10"></div>
        <button
          onClick={handleClose}
        ...
        <h2 className="text-xl w-4/5 mx-auto font-semibold mb-3 text-center !text-blue-900">
